...
class ProjectsTest extends TestCase {
	...
	{
		$this->mock = m::mock('Eloquent', 'Project');
	...
	public function setUp()
	{
		...
		$this->attributes = Factory::project(['id' => 1]);
	...
	public function testUpdate()
	{
		...
		$this->validate(true);
		$this->call('PATCH', 'projects/1');

		$this->assertRedirectedTo('projects/1');
	}
	...
	public function testUpdateFails()
	{
		...
		$this->assertRedirectedTo('projects/1/edit');
		$this->assertSessionHasErrors();
		$this->assertSessionHas('message');
	}
